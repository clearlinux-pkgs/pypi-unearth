...
Source0  : https://files.pythonhosted.org/packages/40/52/f20d419513a91ebbec226b3f7567bf5a662402c63cbd892a5fb1f5352a86/unearth-0.16.1.tar.gz
...
%prep
%setup -q -n unearth-0.16.1
cd %{_builddir}/unearth-0.16.1
pushd ..
cp -a unearth-0.16.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720800673
