...
Version  : 0.11.1
Release  : 7
URL      : https://files.pythonhosted.org/packages/d7/bc/506395f2b59aa2d3743ee835efb58cea9779137a2b89195ac53d32ddde51/unearth-0.11.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/d7/bc/506395f2b59aa2d3743ee835efb58cea9779137a2b89195ac53d32ddde51/unearth-0.11.1.tar.gz
...
%prep
%setup -q -n unearth-0.11.1
cd %{_builddir}/unearth-0.11.1
pushd ..
cp -a unearth-0.11.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697037535
