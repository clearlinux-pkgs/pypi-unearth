...
Source0  : https://files.pythonhosted.org/packages/fb/c1/5d4e3c3696bbec5d9884c38e44e593fb0e67844a76e3af2875bfc79555dd/unearth-0.15.5.tar.gz
...
%prep
%setup -q -n unearth-0.15.5
cd %{_builddir}/unearth-0.15.5
pushd ..
cp -a unearth-0.15.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719330899
