...
Source0  : https://files.pythonhosted.org/packages/42/8c/b9649ad9d54de4ed0b978527f6d7576526290db905e33a28895b585778da/unearth-0.15.1.tar.gz
...
%prep
%setup -q -n unearth-0.15.1
cd %{_builddir}/unearth-0.15.1
pushd ..
cp -a unearth-0.15.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711643003
