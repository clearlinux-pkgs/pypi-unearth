...
Source0  : https://files.pythonhosted.org/packages/c6/34/64d3ba3f69ef9d8afeed59432ba7fac495023408053294cb124aa3c5b356/unearth-0.17.3.tar.gz
...
%prep
%setup -q -n unearth-0.17.3
cd %{_builddir}/unearth-0.17.3
pushd ..
cp -a unearth-0.17.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742440902
