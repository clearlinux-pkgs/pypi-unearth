...
Source0  : https://files.pythonhosted.org/packages/24/df/033117cc4636974ab79837b37bc79cecb18ff27bf172b5a2f7c4246bd0bc/unearth-0.17.5.tar.gz
...
%prep
%setup -q -n unearth-0.17.5
cd %{_builddir}/unearth-0.17.5
pushd ..
cp -a unearth-0.17.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744174294
