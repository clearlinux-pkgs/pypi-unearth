...
Source0  : https://files.pythonhosted.org/packages/6e/f3/75e1a1edff2d5c0fa74b7f7857b607afc4b4866b1ead6b334e7ecb80e176/unearth-0.15.4.tar.gz
...
%prep
%setup -q -n unearth-0.15.4
cd %{_builddir}/unearth-0.15.4
pushd ..
cp -a unearth-0.15.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717512598
