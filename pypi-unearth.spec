...
Source0  : https://files.pythonhosted.org/packages/2c/8e/55f2075b91268108c97e025275dd6cf0c03ec648ba28834f9c79fbc64fe1/unearth-0.14.0.tar.gz
...
%prep
%setup -q -n unearth-0.14.0
cd %{_builddir}/unearth-0.14.0
pushd ..
cp -a unearth-0.14.0 buildavx2
popd
pushd ..
cp -a unearth-0.14.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707147115
